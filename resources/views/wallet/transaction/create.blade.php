                ...
                <div class="card-body">
                    <form id="paramsForm" name="paramsForm" action="">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="amount" name="amount" placeholder="Amount in JOD">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control category" id="categories" name="categories">
    ...
    form=$('#paramsForm').serialize();
                    ...
                    type: "POST",
                        ...
                        error: function (data) {
                            ...
                            swal({title:"Error", text:"Your updates was canceled", timer:2000, icon:"error"});
